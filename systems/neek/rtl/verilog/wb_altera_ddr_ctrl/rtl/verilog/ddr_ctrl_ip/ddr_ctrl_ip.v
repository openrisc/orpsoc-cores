...
module ddr_ctrl_ip (
	...
	ddr_ctrl_ip_controller_phy	ddr_ctrl_ip_controller_phy_inst(
		...
		.local_self_rfsh_req(signal_wire24),
		.local_self_rfsh_chip(signal_wire25),
...
// Retrieval info:  <NETLIST_SECTION class="altera.ipbu.flowbase.netlist.model.DDRControllerMVCModel"  active_core="ddr_ctrl_ip_controller_phy" >
...
// Retrieval info:      <PRIVATE name = "alt_top" value="ddr_ctrl_ip_alt_mem_ddrx_controller_top"  type="STRING"  enable="1" />
// Retrieval info:      <PRIVATE name = "nativelink_excludes" value="ddr_ctrl_ip_phy_alt_mem_phy_seq.vhd,ddr_ctrl_ip_phy_alt_mem_phy_seq_wrapper.vhd,ddr_ctrl_ip_phy_alt_mem_phy_seq_wrapper.v"  type="STRING"  enable="1" />
// Retrieval info:      <PRIVATE name = "family" value="Cyclone III"  type="STRING"  enable="1" />
// Retrieval info:      <PRIVATE name = "native" value="verilog"  type="STRING"  enable="1" />
// Retrieval info:      <PRIVATE name = "filename" value="ddr_ctrl_ip_alt_mem_ddrx_controller_top.vo"  type="STRING"  enable="1" />
// Retrieval info:     </NAMESPACE>
// Retrieval info:     <NAMESPACE name = "simgen2">
// Retrieval info:      <PRIVATE name = "family" value="Cyclone III"  type="STRING"  enable="1" />
// Retrieval info:      <PRIVATE name = "command" value="--simgen_arbitrary_blackbox=+ddr_ctrl_ip_alt_mem_phy_seq_wrapper;+ddr_ctrl_ip_alt_mem_phy_reconfig;+ddr_ctrl_ip_alt_mem_phy_pll;+ddr_ctrl_ip_phy_alt_mem_phy_delay --ini=simgen_tri_bus_opt=on"  type="STRING"  enable="1" />
// Retrieval info:      <PRIVATE name = "parameter" value="SIMGEN_INITIALIZATION_FILE=/home/franck/openrisc/work/orpsoc-cores/systems/neek/rtl/verilog/wb_altera_ddr_ctrl/rtl/verilog/ddr_ctrl_ip/ddr_ctrl_ip_simgen_init.txt"  type="STRING"  enable="1" />
// Retrieval info:     </NAMESPACE>
...
// Retrieval info:      <PRIVATE name = "filename" value="ddr_ctrl_ip_syn.v"  type="STRING"  enable="1" />
// Retrieval info:     </NAMESPACE>
